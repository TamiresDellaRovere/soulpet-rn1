...
const router = Router(); // Criar o grupo de rotas (/clientes);
...
}); // "/clientes" -> mesma rota pois essa é apenas leitura. -> router.get
...
}); // "/clientes" -> mesma rota pois essa é para inserir dados. -> router.post
...
}); // "/clientes" -> mesma rota pois essa é para atualizar dados. -> router.put
